...
public class StudentServlet extends HttpServlet {
    ...
    protected <SQLException> void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String action = req.getParameter("action");
        if (action==null){
            action="";
        }
    ...
    private void showData(HttpServletRequest req, HttpServletResponse resp) throws SQLException, ServletException, IOException {
        ...
        List<Student> ListStudent = (List<Student>) new StudentService();
    ...
    private void showFormCreate(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Object ClassService = new Object();
        req.setAttribute("Class",ClassService);
        dispatcher.forward(req,resp);
    }
    protected <SQLException> void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String action = req.getParameter("action");
        if (action==null){
            action="";
        }
    ...
    private void create(HttpServletRequest req, HttpServletResponse resp) throws SQLException, ServletException, IOException {
        ...
        ClassServlet classServlet1 = new ClassServlet('id class',name);
        ClassService.save(id class, name);
        RequestDispatcher dispatcher = req.getRequestDispatcher("list.jsp");
        dispatcher.forward(req,resp);
    }
