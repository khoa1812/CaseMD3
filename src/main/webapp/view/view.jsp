...
<div class="container">
    ...
    <form>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="gradeToan" name="gradeToan" value="${student.gradeToan}" readonly>
        </div>
        <div class="mb-3">
            <label for="gradeVan" class="form-label">Điểm Văn:</label>
            <input type="text" class="form-control" id="gradeVan" name="gradeVan" value="${student.gradeVan}" readonly>
        </div>
        <div class="mb-3">
